...
module.exports = {
    ...
    execute: async (sock, from, msg, args, perms) => {
        ...
        if (targetJid === senderJid)
            return sock.sendMessage(from, { text: '❌ You cannot promote yourself.' });
        ...
        if (targetParticipant.admin === 'admin' || targetParticipant.admin === 'superadmin')
            return sock.sendMessage(from, { text: '❌ That person is already an admin.' });
        ...
        try {
            ...
            await sock.sendMessage(from, {
                text: `❌ Failed to promote @${targetJid.split('@')[0]}. Make sure I'm an admin.`,
                                   mentions: [targetJid]
            });
        }
    }
